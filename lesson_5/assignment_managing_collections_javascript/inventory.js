...
(function() {
  inventory = {
    ...
    setTemplate: function() {
      ...
      this.template = $inventoryItemTemplate.text().trim();
    ...
    addItem: function() {
      ...
      this.collection.push(this.createItem(itemID));
      var itemMarkup = this.template.replace(/ID/g, String(itemID));
      $('#inventory').append(itemMarkup);
    },
    getID: function() {
